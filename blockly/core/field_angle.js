...
Blockly.FieldAngle.prototype.updateGraph_ = function() {
  ...
  // for drawing, I want an angle between 0 and 360. (Blockscad!)
  var degrees = Number(this.getText()) % 360;
  if (degrees < 0) degrees += 360;

  var angleRadians = goog.math.toRadians(degrees);
...
Blockly.FieldAngle.angleValidator = function(text) {
  ...
  if (n !== null) {
    // don't change n to be between 0 and 360 for blockscad.
    n = String(n);
   }
  return n;
};
