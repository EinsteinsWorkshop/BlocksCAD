...
Blockly.BlockSvg.prototype.onMouseMove_ = function(e) {
  ...
  Blockly.doCommand(function() {
    ...
    if (Blockly.dragMode_ == 2) {
      ...
      var closestConnectionBad = null;   // for BlocksCAD - draw illegal connections
      ...
      //console.log("closestConnectionBad is:",closestConnectionBad);
...
Blockly.BlockSvg.prototype.updateColour = function() {
  ...
  // for blockscad, I'm using hex colors directly.
  // var hexColour = Blockly.makeColour(this.getColour());

  var hexColour = this.getColourHex();
