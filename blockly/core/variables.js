...
// getInstances is used for BlocksCAD - keep it!
/**
 * Find all instances of a particular variable and return the list of blocks.
 * @param {string} name Name of the variable to find instances of
