...
Blockly.Msg.CONTROLS_FOR_TOOLTIP_CHAINHULL = 'Return the convex hull of each shape in the loop with the next shape';
Blockly.Msg.CONTROLS_FOR_INPUT_WITH_CHAINHULL = 'Chain Hull: count with'
...
Blockly.Msg.MATH_CONSTANT_TOOLTIP = 'Return one of the common constants: π (3.141…), e (2.718…), φ (golden ratio: 1.618…), sqrt(2) (1.414…), or sqrt(½) (0.707…)';
...
/// context menu - This appears on the context menu for function calls and definitions.  Selecting
/// it causes the corresponding function instancse to be highlighted (as shown at
/// [[Translating:Blockly#context_menus]].
Blockly.Msg.PROCEDURES_HIGHLIGHT_CALLERS = 'Highlight function instances';
