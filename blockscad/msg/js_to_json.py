...
The file qqq.json would get:
    ...
    "Blockscad.SOME_KEY", "Here is a description of the following message.",

Commas would of course be omitted for the final entry of each value.

@author Ellen Spertus (ellen.spertus@gmail.com)
modified by J. Yoder for Blockscad strings
"""
...
def main():
  ...
  parser.add_argument(
      '--author',
      default='Jennie Yoder <jennie@einsteinsworkshop.com>',
