...
output += '              <li><a href="/docs/" target="_blank">' + Blockscad.Msg.DOCUMENTATION + '</a></li>\n';
// output += '<!--               <li class="divider"></li>\n';
// output += '              <li><a href="#" id="colorPicker">Color Picker</a></li> -->\n';
output += '              <li class="divider"></li>\n';
output += '              <li><a href="#" data-toggle="modal" data-target="#about-modal">' + Blockscad.Msg.ABOUT + '</a></li>\n';
output += '            </ul>\n';
output += '          </li>\n';
output += '          <li class="dropdown">\n';
...
output += '                  <button type="button" class="btn btn-default btn-lg " id="renderButton">' + Blockscad.Msg.RENDER_BUTTON + '</button>\n';
...
output += '                    <button type="button" class="btn btn-default btn-lg" id="stlButton">' + Blockscad.Msg.GENERATE_STL + '</button>\n';
output += '                  </div>\n';
output += '                  <div id="render-ongoing">' + Blockscad.Msg.RENDERING + '<img id=busy src="imgs/busy2.gif"></div>\n';
